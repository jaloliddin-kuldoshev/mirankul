...
<div class="box">
	<div class="box-header with-border">
		<h3 class="box-title"><a type="button" href="/admin-panel/video" class="btn btn-block btn-success">Назад</a></h3>
		...
		<div class="box-body">
			<form role="form" id="aboutVideo" method="post" action="{{ route('video.store') }}"  enctype="multipart/form-data">
				{{ csrf_field() }}
				<div class="box-body">
