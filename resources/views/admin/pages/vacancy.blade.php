 ...
 <div class="box">
 	<div class="box-header with-border">
 		...
 		<div class="box-body">
 			<form role="form" method="post" action="{{ action('Admin\AdminController@vacancy') }}"  enctype="multipart/form-data">
 				{{ csrf_field() }}
 				<div class="box-body">
 					...
 					<div class="form-group">
 						<label for="exampleInputEmail1">Нижний текст</label>
 						<textarea class="form-control ckeditor" name="text1" rows="3" id="">{{ $news->text1 }}</textarea>
 					</div>
 					<div class="form-group">
