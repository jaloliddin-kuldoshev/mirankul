...
<div class="box">
	<div class="box-header with-border">
		...
		<div class="box-body">
			<form role="form" id="aboutVideo" method="post" action="{{ route('video.update', ['id' => $news->id]) }}"  enctype="multipart/form-data">
				...
				<div class="box-body">
					<div class="form-group">
						...
						<select class="form-control" name="works_id" required>
							...
							@foreach($work  as $cat)
							<option value="{{ $cat->id }}" @if($cat->id == $news->works_id) selected @endif>{{ $cat->title }}</option>
							@endforeach
						</select>
					...
					<div class="form-group">
						...
						<input type="file" class="dropify" name="path" data-default-file="{{ asset($news->path) }}" id="uploadFile" accept="video/*">
						@if($errors->has('path'))
